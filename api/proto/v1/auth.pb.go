...
type SignUpResponce struct {
	...
	Status          SignupStatus           `protobuf:"varint,2,opt,name=status,proto3,enum=auth.v1.SignupStatus" json:"status,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\rv1/auth.proto\x12\aauth.v1\x1a\x1cgoogle/api/annotations.proto\"\x85\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x11signup_session_id\x18\x01 \x01(\tR\x0fsignupSessionId\x12-\n" +
	"\x06status\x18\x02 \x01(\x0e2\x15.auth.v1.SignupStatusR\x06status\"^\n" +
	"\fAuthResponse\x12!\n" +
	"\x04user\x18\x01 \x01(\v2\r.auth.v1.UserR\x04user\x12+\n" +
	"\x06tokens\x18\x02 \x01(\v2\x13.auth.v1.AuthTokensR\x06tokens*t\n" +
	...
	"\x0eINTERNAL_ERROR\x10\x042l\n" +
	"\vAuthService\x12]\n" +
	"\x0eInitiateSignup\x12\x16.auth.v1.SignUpRequest\x1a\x17.auth.v1.SignUpResponce\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/auth/signupB\x15Z\x13api/proto/v1;authpbb\x06proto3"
...
var file_v1_auth_proto_goTypes = []any{
	(SignupStatus)(0),      // 0: auth.v1.SignupStatus
	(*User)(nil),           // 1: auth.v1.User
	(*AuthTokens)(nil),     // 2: auth.v1.AuthTokens
	(*SignUpRequest)(nil),  // 3: auth.v1.SignUpRequest
	(*SignUpResponce)(nil), // 4: auth.v1.SignUpResponce
	(*AuthResponse)(nil),   // 5: auth.v1.AuthResponse
}
var file_v1_auth_proto_depIdxs = []int32{
	0, // 0: auth.v1.SignUpResponce.status:type_name -> auth.v1.SignupStatus
	1, // 1: auth.v1.AuthResponse.user:type_name -> auth.v1.User
	2, // 2: auth.v1.AuthResponse.tokens:type_name -> auth.v1.AuthTokens
	3, // 3: auth.v1.AuthService.InitiateSignup:input_type -> auth.v1.SignUpRequest
	4, // 4: auth.v1.AuthService.InitiateSignup:output_type -> auth.v1.SignUpResponce
